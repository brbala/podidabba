...
<div id="footer-wrapper">
        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','natural-herbs-lite');?><?php if( is_home() && is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/');?>" target="_blank"><?php esc_html_e('SKT Themes','natural-herbs-lite'); ?></a>
        <?php } else {?>
          <?php esc_html_e('SKT Themes','natural-herbs-lite'); ?>
        <?php } ?></div>
                 <div class="clear"></div>
            </div>           
        </div>
